...
def process_beach_hero():
    source_path = r"C:\Users\virgi\Desktop\REBRANDING PLAYA\Foto video sito Playa\hero SPIAGGIA.jpg"
    dest_dir = r"c:\Users\virgi\Desktop\REBRANDING PLAYA\frontend\assets\images"
    
    desktop_dest = os.path.join(dest_dir, "hero-lido.webp")
    mobile_dest = os.path.join(dest_dir, "mobile-hero-lido.webp")
    ...
    try:
        ...
        with Image.open(source_path) as img:
            ...
            print("\nAggiornamento Hero Spiaggia completato con successo!")
